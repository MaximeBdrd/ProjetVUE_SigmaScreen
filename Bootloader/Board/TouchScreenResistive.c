...
void 	TouchStoreCalibration(short*);
void 	TouchCheckForCalibration(void);
void 	TouchLoadCalibration(short*);
...
*
********************************************************************/
void TouchStoreCalibration(short* pCalibration)
{
 	if (pCalibration != NULL)
	{
    	...
    	pCalDataWrite(mchpTouchScreenVersion, ADDRESS_RESISTIVE_TOUCH_VERSION);*/
            pCalibration[ADDRESS_RESISTIVE_TOUCH_ULX] = xRawTouch[0];
            pCalibration[ADDRESS_RESISTIVE_TOUCH_ULY] = yRawTouch[0];
            pCalibration[ADDRESS_RESISTIVE_TOUCH_URX] = xRawTouch[1];
            pCalibration[ADDRESS_RESISTIVE_TOUCH_URY] = yRawTouch[1];
            pCalibration[ADDRESS_RESISTIVE_TOUCH_LLX] = xRawTouch[3];
            pCalibration[ADDRESS_RESISTIVE_TOUCH_LLY] = yRawTouch[3];
            pCalibration[ADDRESS_RESISTIVE_TOUCH_LRX] = xRawTouch[2];
            pCalibration[ADDRESS_RESISTIVE_TOUCH_LRY] = yRawTouch[2];
...
*
********************************************************************/
void TouchLoadCalibration(short* pCalibration)
{

	if (pCalibration != NULL)
	{

    	xRawTouch[0] = pCalibration[ADDRESS_RESISTIVE_TOUCH_ULX];
    	yRawTouch[0] = pCalibration[ADDRESS_RESISTIVE_TOUCH_ULY];

    	xRawTouch[1] = pCalibration[ADDRESS_RESISTIVE_TOUCH_URX];
    	yRawTouch[1] = pCalibration[ADDRESS_RESISTIVE_TOUCH_URY];

    	xRawTouch[3] = pCalibration[ADDRESS_RESISTIVE_TOUCH_LLX];
    	yRawTouch[3] = pCalibration[ADDRESS_RESISTIVE_TOUCH_LLY];

    	xRawTouch[2] = pCalibration[ADDRESS_RESISTIVE_TOUCH_LRX];
    	yRawTouch[2] = pCalibration[ADDRESS_RESISTIVE_TOUCH_LRY];
